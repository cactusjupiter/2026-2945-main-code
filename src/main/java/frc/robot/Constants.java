...
public class Constants {
    ...
    public static final int CLIMB_LIMIT_TOP = 2;
    public static final int CLIMB_LIMIT_BTM = 3;
    public static final int PIVOT_1_ID = 41;
    public static final int PIVOT_2_ID = 67;
    public static final int PIVOT_LIMIT_FWD = 4;
    public static final int PIVOT_LIMIT_BCK = 5;
